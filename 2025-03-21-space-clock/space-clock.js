...
function drawEarth(){
  ...
  rotate(axisAngle-90)
    // Draw latitude lines
    for (i = 1; i < 3; i++){
      circle(0, earthPoleTilt, i * 10)
    }
    arc(0, earthPoleTilt, 30, 30, 155,  25)
    arc(0, earthPoleTilt, 40, 40, 190, 350)
    arc(0, earthPoleTilt, 50, 50, 213, 327)
    arc(0, earthPoleTilt, 60, 60, 237, 303) 
    resetGraphics()
